 ...
 */
export declare function generateStrongCompactUuid(): string;
/**
 ...
 */
export declare function generateShortLowercaseUuid(): string;
/**
 ...
 */
export declare function generateLongLowercaseUuid(shouldRemoveHyphens?: boolean): string;
/**
 ...
 */
export declare function generateProfanitySafeUuid(): string;
/**
 ...
 */
export declare function generateCustomUuid(dictionary: string, length: number): string;
/**
