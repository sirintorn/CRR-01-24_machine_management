...
exports.generateTimestampId = exports.generateCustomUuid = exports.generateProfanitySafeUuid = exports.generateLongLowercaseUuid = exports.generateShortLowercaseUuid = exports.generateStrongCompactUuid = exports.generateShortUuid = void 0;
 ...
 */
function generateStrongCompactUuid() {
    return generateCustomUuid("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 20);
}
exports.generateStrongCompactUuid = generateStrongCompactUuid;
/**
 ...
 */
function generateShortLowercaseUuid() {
    return generateCustomUuid("0123456789abcdefghijklmnopqrstuvwxyz", 20);
}
exports.generateShortLowercaseUuid = generateShortLowercaseUuid;
/**
 ...
 */
function generateLongLowercaseUuid(shouldRemoveHyphens = false) {
...
exports.generateLongLowercaseUuid = generateLongLowercaseUuid;
/**
 ...
 */
function generateProfanitySafeUuid() {
    const partLength = 10;
...
exports.generateProfanitySafeUuid = generateProfanitySafeUuid;
/**
