import { AccuracyTest } from "../models/m_accuracy_tests";
import { DTO } from "./dto";

export class DTOAccuracyTest extends DTO{
    id?: any;
    ...
    static convert(dto: DTOAccuracyTest): AccuracyTest{
        return dto as AccuracyTest;
    }
}