...
import { TintingProfile, TintingProfileSchema } from "../models/m_tinting_profiles";
...
//GET SINGLE BY MACHINE-ID
TintingProfileRoute.route(path + '/:machine_id').get(async (req, res) => {
    try {
...
//IMPORT TINTING PROFILE
TintingProfileRoute.route(path + '/:machine_id/import').post(async (req, res) => {
    try {
        const machine_id = req.params.machine_id;
...
//CREATE CIRCUIT INFO MULTIPLE
TintingProfileRoute.route(path + '/circuit-info/multiple').post(async (req, res) => {
    try {
        const circuitInfoSCH = new CircuitInfoSchema();
        const body = req.body;
...
//CREATE CALIBRATION INFO MULTIPLE
TintingProfileRoute.route(path + '/calibration-info/multiple').post(async (req, res) => {
    try {
        const calibrationInfoSCH = new CalibrationInfoSchema();
        const body = req.body;
...
//CREATE VOLUME CALIBRATION TARGET MULTIPLE
TintingProfileRoute.route(path + '/volume-calibration-target/multiple').post(async (req, res) => {
    try {
        const volumeCalibrationTargetSCH = new VolumeCalibrationTargetSchema();
        const body = req.body;
...
//CREATE STEP CALIBRATION TARGET MULTIPLE
TintingProfileRoute.route(path + '/step-calibration-target/multiple').post(async (req, res) => {
    try {
        const stepCalibrationTargetSCH = new StepCalibrationTargetSchema();
        const body = req.body;
...
//CREATE ACCURACY TEST MULTIPLE
TintingProfileRoute.route(path + '/accuracy-test-target/multiple').post(async (req, res) => {
    try {
        const accuracyTestTargetSCH = new AccuracyTestTargetSchema();
        const body = req.body;
...
TintingProfileRoute.route(path + '/tests/interpolation').get(async (req, res) => {
    try {
        let calibrationInfos = [
            ...
            },
            {
                ...
                "result_step": 18,
                "result_ml": 0.0672,
                "result_g": 0.096666667,
                "result_err_rate": 3.29,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 110,
                "result_ml": 0.3063,
                "result_g": 0.392666667,
                "result_err_rate": -1.97,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 48,
                "result_ml": 0.0738,
                "result_g": 0.094666667,
                "result_err_rate": 5.86,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 153,
                "result_ml": 0.4997,
                "result_g": 0.616666667,
                "result_err_rate": -0.82,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 26,
                "result_ml": 0.0735,
                "result_g": 0.090666667,
                "result_err_rate": 7.71,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 50,
                "result_ml": 0.0786,
                "result_g": 0.092333333,
                "result_err_rate": 8.29,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 87,
                "result_ml": 0.2998,
                "result_g": 0.351666667,
                "result_err_rate": -2.23,
                "status": "Passed",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
            ...
            },
            {
                ...
                "result_step": 24,
                "result_ml": 0.0779,
                "result_g": 0.091333333,
                "result_err_rate": 13.29,
                "status": "Accepted",
                "created": 44855.60028,
                "modified": 45175.44294,
                "created_at": "2024-08-13T04:35:39.119Z",
        ...
        const result = DispenseInterpolation.findTargetStep(calibrationInfos, "AXX", 0.4);
